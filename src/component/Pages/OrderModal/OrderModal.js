...
const OrderModal = ({orderProducts, setOrderProducts}) => {
    ...
    const {name, quantity, price} = orderProducts
    ...
    const handleOrder = event =>{
        ...
        console.log( quantity, names, email, phone, price);
        const order = {
            productName: product,
            name: names,
            quantity,
        ...
        <div className="modal">
            <div className="modal-box relative">
                ...
                <form onSubmit={handleOrder} className='grid grid-cols-1 gap-3 mt-10'>
                    ...
                    <select name='quantity' className="select select-bordered w-full" disabled>
